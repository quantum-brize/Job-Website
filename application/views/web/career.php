                ...
                <div class="col-lg-3">
                    <div class="lefttopfixed">
                        <div class="allpagesview-left" data-aos="fade-up" data-aos-duration="1000">
                            <div class="left_subheading">Jobs</div>
                    ...
                    <div class="col-lg-5 col-sm-6">
                        <div class="connectus" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="0">
                            ...
                            <ul class="socialmedia">
                                <li class="facebook_color"><a href="#" target="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                </li>
                                <li class="linkedin_color"><a href="#" target="_blank"><i
                                            class="fa fa-linkedin"></i></a>
                                </li>
                                <li class="instagram_color"><a href="#" target="_blank"><i
                                            class="fa fa-instagram"></i></a>
                                </li>
                                <li class="youtube_color"><a href="#" target="_blank"><i
